$(document).ready(function() {
    ...
    var topics = [];
      ...
      //Click event on gifs with class of "celebGiphy" executes pausePlayGifs function
      $(document).on("click", ".celebGiphy", pausePlayGifs);
